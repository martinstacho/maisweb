    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <nav className="border-b border-slate-800 bg-slate-900/60 px-6 py-4">
        <div className="mx-auto flex max-w-7xl items-center gap-4">
          ...
          <span className="text-sm text-slate-300">Nová referencia</span>
        </div>
      </nav>
      <main className="mx-auto max-w-3xl px-6 py-12">
        <h1 className="text-3xl font-black mb-10">Pridať referenciu</h1>
        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-8">
          <TestimonialForm partners={partners} />
        </div>
      </main>
    </div>
  )
