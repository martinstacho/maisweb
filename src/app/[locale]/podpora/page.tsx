  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg)', color: 'var(--fg)' }}>
      ...
      <section className="relative overflow-hidden py-24 px-6">
        <div className="absolute inset-0 hero-grid-sm pointer-events-none opacity-60" />
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          <FadeIn>
            <div className="kicker justify-center mb-6">Podpora MAIS</div>
            <h1 className="font-display text-[48px] md:text-[72px] leading-[0.95] mb-6">
              <span className="gradient-text">Sme tu</span>
              <br />
              <span style={{ color: 'var(--fg)' }}>pre vás</span>
            </h1>
            <p className="text-[17px] leading-relaxed max-w-xl mx-auto" style={{ color: 'var(--fg-2)' }}>
      ...
      <section className="px-6 pb-16">
        <FadeIn>
          <div className="mx-auto max-w-2xl bento-card p-8">
            <div className="stripe" />
            <div className="kicker mb-5">ITernal s.r.o. — Hlavná podpora</div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <div className="mono text-[10px] tracking-wider mb-2" style={{ color: 'var(--fg-4)' }}>TELEFÓN</div>
                <a href="tel:+421915724757" className="action-row">
                ...
                <div className="mono text-[10px] mt-2" style={{ color: 'var(--fg-4)' }}>Po–Pia 9:00 – 15:00</div>
              </div>
              <div>
                <div className="mono text-[10px] tracking-wider mb-2" style={{ color: 'var(--fg-4)' }}>E-MAIL</div>
                <a href="mailto:podpora@mais.sk" className="action-row primary">
                  <span className="flex items-center gap-2">
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <section className="border-t px-6 py-20" style={{ borderColor: 'var(--line)', background: 'var(--bg-2)' }}>
        <div className="mx-auto max-w-7xl">
          <FadeIn className="mb-10 text-center">
            <div className="kicker justify-center mb-3">Kontakty podľa školy</div>
            <h2 className="font-display text-[30px] md:text-[42px]" style={{ color: 'var(--fg)' }}>
              Helpdesk vašej <span className="gradient-text">inštitúcie</span>
            </h2>
          </FadeIn>
