...
export async function PartnerCard({ partner, locale, index = 0 }: { partner: Partner; locale?: string; index?: number }) {
  ...
  return (
    ...
    >
      ...
      {/* Divider */}
      <div className="mb-4" style={{ borderTop: '1px solid var(--line)' }} />

      {/* Bottom row */}
      <div className="flex items-center justify-between text-[12px]" style={{ color: 'var(--fg-3)' }}>
        ...
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--orange)' }}>
